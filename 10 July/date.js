...
// let date = new Date();
// // console.log(date.setYear(1990));
// date.setYear(1990);
// console.log(date);


// getUTCFullYear() :- get year of the given date according to universal time.
// let date = new Date();
...
// const date2 = new Date('August 20, 1975 23:15:30');
